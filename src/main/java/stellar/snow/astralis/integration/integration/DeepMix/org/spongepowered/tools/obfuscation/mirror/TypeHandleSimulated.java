...
extends TypeHandle {
    ...
    public MappingMethod getMappingMethod(String name, String desc) {
        ...
        MethodHandle method = TypeHandleSimulated.findMethodRecursive(this, name, signature, rawSignature = TypeUtils.stripGenerics(signature), true, this.typeProvider);
    ...
    private static MethodHandle findMethodRecursive(TypeHandle target, String name, String signature, String rawSignature, boolean matchCase, ITypeHandleProvider typeProvider) {
        ...
        for (TypeMirror typeMirror : elem.getInterfaces()) {
            method = TypeHandleSimulated.findMethodRecursive(typeMirror, name, signature, rawSignature, matchCase, typeProvider);
