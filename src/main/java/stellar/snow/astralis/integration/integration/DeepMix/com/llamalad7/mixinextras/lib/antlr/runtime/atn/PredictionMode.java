...
extends Enum<PredictionMode> {
    public static final /* enum */ PredictionMode SLL = new PredictionMode();
    public static final /* enum */ PredictionMode LL = new PredictionMode();
    public static final /* enum */ PredictionMode LL_EXACT_AMBIG_DETECTION = new PredictionMode();
    ...
    static {
        $VALUES = new PredictionMode[]{SLL, LL, LL_EXACT_AMBIG_DETECTION};
    }
