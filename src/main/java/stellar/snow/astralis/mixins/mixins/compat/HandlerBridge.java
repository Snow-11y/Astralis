 ...
 * ╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
 * ║                                                                                                                ║
 * ║                              Astralis Universal Compatibility Layer                                             ║
 ...
 * ║  and the Astralis handler chain. When the compatibility layer transforms an @Overwrite                         ║
 * ║  method, the generated bytecode calls into this class to:                                                     ║
 * ║    1. Acquire a zero-allocation OperationContext from the pool                                                ║
 * ║    2. Execute the Astralis handler chain                                                                       ║
...
package stellar.snow.astralis.mixins.compat;
...
/**
 * HandlerBridge — The critical runtime interface for Astralis compatibility layer.
 * 
...
public final class HandlerBridge {
    ...
    /** Debug mode flag */
    private static final boolean DEBUG_MODE = Boolean.getBoolean("astralis.debug");
    ...
    private static void initializeLogging() {
        try {
            ...
            System.err.println("[Astralis] Failed to initialize bytecode log: " + e.getMessage());
    ...
    private static void writeBytecodeLogHeader() {
        ...
        synchronized (logLock) {
            ...
            bytecodeLogWriter.println("║  Astralis Universal Compatibility Layer. It records:                                                             ║");
    ...
    public static List<String> generateAndLogWrapperBytecode(String className, String methodName,
        ...
        instructions.add("// Generated by Astralis Universal Compatibility Layer");
        instructions.add("// ═══════════════════════════════════════════════════════════════════════════════");
        instructions.add("");
        ...
        instructions.add("// SECTION 5: Execute Astralis Handler Chain");
        instructions.add(String.format("%04d: ALOAD %d                     // Load ctx", instrOffset++, contextSlot));
